...
public:
  ...
  FirebaseAdminReply *send(const FirebaseMessage &message,
                           bool validateOnly = false);

  FirebaseAdminReply *appInfo(const QString &iidToken, bool details = true);
  FirebaseAdminReply *appSubscribeToTopic(const QString &iidToken,
                                          const QString &topic);
   ...
   * \return
   */
  FirebaseAdminReply *appsSubscribeToTopic(const QStringList &iidTokens,
                                           const QString &topic);
   ...
   * \return
   */
  FirebaseAdminReply *appsUnsubscribeToTopic(const QStringList &iidTokens,
                                             const QString &topic);
