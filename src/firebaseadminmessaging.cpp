...
FirebaseAdminReply *FirebaseAdminMessaging::appInfo(const QString &iidToken,
                                                    bool details) {
  FirebaseAdminReply *reply = new FirebaseAdminReply;
...
FirebaseAdminReply *
FirebaseAdminMessaging::appSubscribeToTopic(const QString &iidToken,
                                            const QString &topic) {
  FirebaseAdminReply *reply = new FirebaseAdminReply;
  ...
  QNetworkReply *namReply =
      m_admin->networkAccessManager()->post(req, QByteArray());
  reply->setNetworkReply(namReply);
  return reply;
}

FirebaseAdminReply *
FirebaseAdminMessaging::appsSubscribeToTopic(const QStringList &iidTokens,
                                             const QString &topic) {
  FirebaseAdminReply *reply = new FirebaseAdminReply;
  ...
  QJsonObject obj{
      ...
      {QStringLiteral("registration_tokens"),
       QJsonArray::fromStringList(iidTokens)},
  };
...
FirebaseAdminReply *
FirebaseAdminMessaging::appsUnsubscribeToTopic(const QStringList &iidTokens,
                                               const QString &topic) {
  FirebaseAdminReply *reply = new FirebaseAdminReply;
...
void FirebaseMessage::setNotification(const QString &title,
                                      const QString &body) {
...
void FirebaseMessage::setToken(const QString &token) { m_token = token; }

void FirebaseMessage::setTopic(const QString &topic) { m_topic = topic; }

QString FirebaseMessage::topic() const { return m_topic; }
...
void FirebaseApnsNotification::setHeaders(
...
void FirebaseApnsNotification::setFcmOptions(const QString &analyticsLabel,
                                             const QString &image) {
  m_apnsFcmOptions = {
