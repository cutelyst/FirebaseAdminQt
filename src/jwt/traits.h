...
struct qt_json {
    ...
    struct value_type : QJsonValue {
        ...
        value_type(const std::string &value) : QJsonValue{QString::fromStdString(value)} {}
    };
    ...
    static jwt::json::type get_type(const value_type &val) {
        ...
        case QJsonValue::Double:
            return (std::trunc(val.toDouble()) == val.toDouble()) ? type::integer : type::number;
    ...
    // }
           ...
           // static QString substring(const QString &str, integer_type pos, integer_type len) {
           //     return str.mid(pos, len);  // Equivalent to std::string::substr for QString
           // }
    ...
    static bool parse(value_type &val, const string_type &str) {
        ...
        QJsonDocument doc = QJsonDocument::fromJson(QByteArray::fromStdString(str), &error);
